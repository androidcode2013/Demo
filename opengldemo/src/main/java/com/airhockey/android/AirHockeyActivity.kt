...
class AirHockeyActivity: Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var airHockeyRenderer = AirHockeyRenderer(this)
        renderSet = true
        ...
        mGLSurfaceView!!.setOnTouchListener(View.OnTouchListener { v, event ->
            if (event != null) {
                var normalizedX: Float = (event.x / v.width) * 2 - 1
                var normalizedY: Float = -((event.y / v.height) * 2 - 1)
